...
$query = 'SELECT  `locationLatitude`, `locationLongitude` FROM `parcels` WHERE 1 ';
        ...
        <script>
            function initMap() {
                var mapOptions = {
                    ...
                    center: {
                        <? php
                        //  if (isset($latitudes[0] != NULL || $longitudes[0] != NULL)){

                         echo 'lat:' . $latitudes[0] . ', lng:' . $longitudes[0];
                ...
                endPoint = {
                    <?php
                    // if (isset($latitudes[0] != NULL || $longitudes[0] != NULL)){
                    echo 'lat:' . $latitudes[$lastcount] . ', lng:' . $longitudes[$lastcount];
                    ?>
                };
